  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \item
        InputKinem: TTree con mappa tra eventi di input ed eventi simulati.
        Per ogni evento simulato riporta a quale file di input (inputFileNum) ed
        a quale evento (inputEntryNum) corrisponde
        \item
