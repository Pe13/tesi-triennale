...
\subsection{Obbiettivi scientifici} \label{subsec:obbiettivi-scientifici}
  Il programma scientifico di DUNE è diviso in obbiettivi primari: quelli per
  i quali l'esperimento è effettivamente realizzato; e secondari: obbiettivi
  ...
  \end{itemize}
  Gli obbiettivi secondari sono invece:
  \begin{itemize}
