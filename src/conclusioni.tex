...
\chapter*{Conclusioni}
  ...
  \textit{pipeline} di analisi ancor prima che i complessi algoritmi di
  ricostruzione delle tracce fossero ultimati.
  Inoltre, il formato \textit{Common Analysis File} (CAF), usato per i file
  di output, rappresenta delle strutture dati nuove per la
  collaborazione e ancora in via di sviluppo, che richiedevano un meccanismo di
  popolamento affidabile per poterne studiare a fondo il design e
  individuarne eventuali mancanze.
  ...
  Grazie a questo lavoro, è ora disponibile un \textit{workflow} operativo in
  grado di generare file CAF strutturalmente completi.
  ...
  La \textit{roadmap} prevede l'evoluzione del modulo attuale in fast-reco,
