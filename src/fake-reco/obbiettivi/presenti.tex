...
\section{Obbiettivi raggiunti} \label{sec:obbiettivi-raggiunti}
  %    - propedeuticità al riempimento dei caf con roba vera
  %    - validazione input
  %    - testare analisi dati su oggetti completi
  \begin{figure}[ht]
    \centering
    \includegraphics[width=.95\textwidth]{fake-reco/fake-reco-v0}
    \caption{
  ...
  raggiunto i seguenti obbiettivi / offre le seguenti funzionalità:
